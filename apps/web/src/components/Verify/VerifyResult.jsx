...
import { ShieldCheck, CheckCircle2, AlertTriangle, ChevronLeft, Info } from 'lucide-react';
        ...
        <div style={{ 
          ...
          {!isVerified && (
            <div style={{ 
              ...
              <AlertTriangle size={24} color="#E65100" style={{ flexShrink: 0 }} />
              <p style={{ color: '#663C00', fontSize: '13px', fontWeight: 700, lineHeight: 1.5 }}>
                WARNING: This institution/professional is NOT currently recognized as a valid practitioner in the national database. Do not proceed with payments or enrollment.
              </p>
            </div>
          )}
        </div>
